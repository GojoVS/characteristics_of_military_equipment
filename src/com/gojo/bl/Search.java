...
import com.gojo.dao.Airmilitaryequipment;
import com.gojo.dao.Militarynavalforces;
import com.gojo.dao.Groundmilitaryequipment;
import com.gojo.dao.ReaderFile;
import java.io.*;
...
public class Search {
  ...
  public static void find() throws IOException {
    ...
    for (File file : Groundmilitaryequipment.getListOfGroundmilitaryequipment()) {
      ...
      if (enteredFile.equals(forComparison)) {
        ...
        ReaderFile readerFile = new Groundmilitaryequipment();
        readerFile.readFile(file);
        return;
      }
    }
    for (File file : Militarynavalforces.getListOfMilitarynavalforces()) {
      ...
      if (enteredFile.equals(forComparison)) {
        System.out.print(ConsoleColor.CYAN_BOLD_BRIGHT);
        System.out.println("Файл знайдений");
        ReaderFile readerFile = new Militarynavalforces();
        readerFile.readFile(file);
        return;
      }
    }

    for (File file : Airmilitaryequipment.getListOfAirmilitaryequipment()) {
      ...
      if (enteredFile.equals(forComparison)) {
        System.out.print(ConsoleColor.CYAN_BOLD_BRIGHT);
        System.out.println("\nФайл знайдений\n");
        ReaderFile readerFile = new Airmilitaryequipment();
        readerFile.readFile(file);
        return;
      }
    }
